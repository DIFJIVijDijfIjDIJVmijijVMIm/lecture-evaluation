package com.cos.lecture.aop.info;
...
public class LogAdvice {
	...
	@Around("execution(* com.cos.lecture.controller..*Controller.*(..))"
			+" or execution(* com.cos.lecture.service..*Service.*(..))"
			+" or execution(* com.cos.lecture.repository..*Repository.*(..))")
